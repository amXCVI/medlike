...
Future<Widget> withApp(
    [Widget? child, AppointmentsRepository? appointmentsRepository]) async {
  ...
  return App(testChild: child, appointmentsRepository: appointmentsRepository);
}
