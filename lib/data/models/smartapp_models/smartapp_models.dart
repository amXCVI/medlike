...
@freezed
class SmartappSendBotEventPayloadResultModel with _$SmartappSendBotEventPayloadResultModel {
  ...
  factory SmartappSendBotEventPayloadResultModel.fromJson(Map<String, Object?> json) =>
      _$SmartappSendBotEventPayloadResultModelFromJson(json);
}

@freezed
class SmartappSendBotEventTokenResponseModel with _$SmartappSendBotEventTokenResponseModel {
  ...
  factory SmartappSendBotEventTokenResponseModel.fromJson(Map<String, Object?> json) =>
      _$SmartappSendBotEventTokenResponseModelFromJson(json);
}

@freezed
class SmartappSendBotEventTokenPayloadModel with _$SmartappSendBotEventTokenPayloadModel {
  const factory SmartappSendBotEventTokenPayloadModel({
    required dynamic result,
    required String? status,
  }) = _SmartappSendBotEventTokenPayloadModel;

  factory SmartappSendBotEventTokenPayloadModel.fromJson(Map<String, Object?> json) =>
