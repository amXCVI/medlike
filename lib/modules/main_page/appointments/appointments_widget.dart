  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppointmentsCubit, AppointmentsState>(
      builder: (context, state) {
        return state.getAppointmentsStatus == GetAppointmentsStatuses.success &&
                          ...
                          items: [
                              ...state.appointmentsList!
                                  ...
                                  .map((appointmentItem) => GestureDetector(
                                        onTap: () {
                                          handleTapOnAppointment(appointmentItem
                                              .appointmentDateTime);
                                        },
                                        child: Container(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              const SizedBox(
                                                                  width: 8.0),
                                                              Text(DateFormat('dd.MM.yyyy, HH:mm').format(dateTimeToUTC(
                                                                  appointmentItem
                                                                      .appointmentDateTime,
                                                                  int.parse(DateTime
                                                                          .now()
