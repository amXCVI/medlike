...
import 'package:medlike/data/models/clinic_models/clinic_models.dart' as _i28;
...
import 'package:medlike/modules/about_clinic/detail_clinic/detail_clinic_page.dart'
    as _i22;
import 'package:medlike/modules/about_clinic/price/price_page.dart' as _i23;
import 'package:medlike/modules/about_clinic/sales/sales_page.dart' as _i24;
...
import 'package:medlike/modules/medcard/medcard_page.dart' as _i19;
import 'package:medlike/modules/settings/settings_page.dart' as _i20;
...
import 'package:medlike/modules/subscribe/specialisations_list/specialisations_list_page.dart'
    as _i13;
import 'package:medlike/navigation/guards.dart' as _i27;
...
class AppRouter extends _i25.RootStackRouter {
  ...
  final _i27.CheckIsSavedPinCode checkIsSavedPinCode;

  final _i27.CheckIsAuthUser checkIsAuthUser;
  ...
  final Map<String, _i25.PageFactory> pagesMap = {
    ...
    MedcardRoute.name: (routeData) {
      return _i25.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i19.MedcardPage());
    },
    ...
    AllClinicsListRoute.name: (routeData) {
      return _i25.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i21.AllClinicsListPage());
    },
    DetailClinicRoute.name: (routeData) {
      final args = routeData.argsAs<DetailClinicRouteArgs>();
      return _i25.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i22.DetailClinicPage(
    ...
    PriceRoute.name: (routeData) {
      ...
      return _i25.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i23.PricePage(key: args.key, clinicId: args.clinicId));
    },
    SalesRoute.name: (routeData) {
      final args = routeData.argsAs<SalesRouteArgs>();
      return _i25.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i24.SalesPage(key: args.key, clinicId: args.clinicId));
    }
  };
  ...
  List<_i25.RouteConfig> get routes => [
        ...
        _i25.RouteConfig(PhoneNumberRoute.name, path: '/login_phone'),
        _i25.RouteConfig(PasswordRoute.name, path: '/login_password'),
        _i25.RouteConfig(CreatePinCodeRoute.name, path: '/login_pin_code'),
        _i25.RouteConfig(CheckPinCodeRoute.name,
            path: '/login_pin_code_check', guards: [checkIsSavedPinCode]),
        _i25.RouteConfig(RecoverPasswordSmsRoute.name,
            path: '/login_recover_password_sms'),
        _i25.RouteConfig(RecoverPasswordNewRoute.name,
            path: '/login_recover_password_new'),
        _i25.RouteConfig(MainRoute.name,
            path: '/main', guards: [checkIsAuthUser]),
        _i25.RouteConfig(AppointmentsRoute.name,
            path: '/my_appointments', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ProfilesListRoute.name,
            path: '/subscribe_profiles', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ClinicsListRoute.name,
            path: '/subscribe_clinics', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ServicesListRoute.name,
            path: '/subscribe_services', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ResearchesListRoute.name,
            path: '/subscribe_researches', guards: [checkIsAuthUser]),
        _i25.RouteConfig(SpecialisationsListRoute.name,
            path: '/subscribe_specialisations', guards: [checkIsAuthUser]),
        _i25.RouteConfig(DoctorsListRoute.name,
            path: '/subscribe_doctors', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ResearchCabinetsListRoute.name,
            path: '/subscribe_research_cabinets', guards: [checkIsAuthUser]),
        _i25.RouteConfig(FavoriteDoctorsListRoute.name,
            path: '/subscribe_favorite_doctors', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ScheduleRoute.name,
            path: '/subscribe_schedule', guards: [checkIsAuthUser]),
        _i25.RouteConfig(ConfirmationSubscribeRoute.name,
            path: '/subscribe_confirm', guards: [checkIsAuthUser]),
        _i25.RouteConfig(MedcardRoute.name,
            path: '/medcard', guards: [checkIsAuthUser]),
        _i25.RouteConfig(SettingsRoute.name,
            path: '/settings', guards: [checkIsAuthUser]),
        _i25.RouteConfig(AllClinicsListRoute.name,
            path: '/clinic_info', guards: [checkIsAuthUser]),
        _i25.RouteConfig(DetailClinicRoute.name,
            path: '/clinic_info_details', guards: [checkIsAuthUser]),
        _i25.RouteConfig(PriceRoute.name,
            path: '/clinic_info_price', guards: [checkIsAuthUser]),
        _i25.RouteConfig(SalesRoute.name,
...
/// generated route for
/// [_i1.PhoneNumberPage]
class PhoneNumberRoute extends _i25.PageRouteInfo<void> {
...
/// generated route for
/// [_i2.PasswordPage]
class PasswordRoute extends _i25.PageRouteInfo<PasswordRouteArgs> {
  PasswordRoute({_i26.Key? key, required String phoneNumber})
...
class CreatePinCodeRoute extends _i25.PageRouteInfo<void> {
...
class CheckPinCodeRoute extends _i25.PageRouteInfo<void> {
...
class RecoverPasswordSmsRoute
    extends _i25.PageRouteInfo<RecoverPasswordSmsRouteArgs> {
  RecoverPasswordSmsRoute({_i26.Key? key, required String phoneNumber})
...
class RecoverPasswordNewRoute
    extends _i25.PageRouteInfo<RecoverPasswordNewRouteArgs> {
  RecoverPasswordNewRoute({_i26.Key? key, required String smsToken})
...
class AppointmentsRoute extends _i25.PageRouteInfo<AppointmentsRouteArgs> {
  AppointmentsRoute({_i26.Key? key, bool? isRefresh = false})
...
class ProfilesListRoute extends _i25.PageRouteInfo<void> {
...
class ClinicsListRoute extends _i25.PageRouteInfo<ClinicsListRouteArgs> {
  ClinicsListRoute({_i26.Key? key, required String userId})
...
class ServicesListRoute extends _i25.PageRouteInfo<ServicesListRouteArgs> {
  ServicesListRoute(
      {_i26.Key? key,
...
class ResearchesListRoute extends _i25.PageRouteInfo<ResearchesListRouteArgs> {
  ResearchesListRoute(
      {_i26.Key? key,
      required String userId,
      required String buildingId,
...
class SpecialisationsListRoute
    extends _i25.PageRouteInfo<SpecialisationsListRouteArgs> {
...
class DoctorsListRoute extends _i25.PageRouteInfo<DoctorsListRouteArgs> {
  DoctorsListRoute(
      {_i26.Key? key,
      required String userId,
      required String buildingId,
...
class ResearchCabinetsListRoute
    extends _i25.PageRouteInfo<ResearchCabinetsListRouteArgs> {
...
class FavoriteDoctorsListRoute
    extends _i25.PageRouteInfo<FavoriteDoctorsListRouteArgs> {
...
/// generated route for
/// [_i17.SchedulePage]
class ScheduleRoute extends _i25.PageRouteInfo<ScheduleRouteArgs> {
  ScheduleRoute(
      {_i26.Key? key,
...
class ConfirmationSubscribeRoute
    extends _i25.PageRouteInfo<ConfirmationSubscribeRouteArgs> {
  ConfirmationSubscribeRoute({_i26.Key? key, required String userId})
...
/// generated route for
/// [_i19.MedcardPage]
class MedcardRoute extends _i25.PageRouteInfo<void> {
  const MedcardRoute() : super(MedcardRoute.name, path: '/medcard');
...
/// generated route for
/// [_i21.AllClinicsListPage]
class AllClinicsListRoute extends _i25.PageRouteInfo<void> {
...
/// generated route for
/// [_i22.DetailClinicPage]
class DetailClinicRoute extends _i25.PageRouteInfo<DetailClinicRouteArgs> {
  DetailClinicRoute({_i26.Key? key, required _i28.ClinicModel selectedClinic})
...
class DetailClinicRouteArgs {
  ...
  final _i28.ClinicModel selectedClinic;
...
/// generated route for
/// [_i23.PricePage]
class PriceRoute extends _i25.PageRouteInfo<PriceRouteArgs> {
  PriceRoute({_i26.Key? key, required String clinicId})
...
/// generated route for
/// [_i24.SalesPage]
class SalesRoute extends _i25.PageRouteInfo<SalesRouteArgs> {
  SalesRoute({_i26.Key? key, required String clinicId})
