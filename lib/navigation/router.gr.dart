...
import 'package:medlike/data/models/clinic_models/clinic_models.dart' as _i35;
import 'package:medlike/data/models/diary_models/diary_models.dart' as _i36;
...
import 'package:medlike/modules/health/diary_add_page/diary_add_page.dart'
    as _i30;
import 'package:medlike/modules/health/diary_page/diary_page.dart' as _i29;
import 'package:medlike/modules/health/filters_page/filters_page.dart' as _i31;
...
import 'package:medlike/modules/subscribe/specialisations_list/specialisations_list_page.dart'
    as _i13;
import 'package:medlike/navigation/guards.dart' as _i34;
...
class AppRouter extends _i32.RootStackRouter {
  ...
  final _i34.CheckIsSavedPinCode checkIsSavedPinCode;

  final _i34.CheckIsAuthUser checkIsAuthUser;
  ...
  final Map<String, _i32.PageFactory> pagesMap = {
    ...
    HealthRoute.name: (routeData) {
      return _i32.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i28.HealthPage());
    },
    DiaryRoute.name: (routeData) {
      final args = routeData.argsAs<DiaryRouteArgs>();
      return _i32.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i29.DiaryPage(
              key: args.key,
              title: args.title,
  ...
  List<_i32.RouteConfig> get routes => [
        ...
        _i32.RouteConfig(StartPhoneNumberRoute.name, path: '/login_phone'),
        _i32.RouteConfig(PasswordRoute.name, path: '/login_password'),
        _i32.RouteConfig(CreatePinCodeRoute.name, path: '/login_pin_code'),
        _i32.RouteConfig(CheckPinCodeRoute.name,
            path: '/login_pin_code_check', guards: [checkIsSavedPinCode]),
        _i32.RouteConfig(RecoverPasswordSmsRoute.name,
            path: '/login_recover_password_sms'),
        _i32.RouteConfig(RecoverPasswordNewRoute.name,
            path: '/login_recover_password_new'),
        _i32.RouteConfig(MainRoute.name,
            path: '/main', guards: [checkIsAuthUser]),
        _i32.RouteConfig(AppointmentsRoute.name,
            path: '/my_appointments', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ProfilesListRoute.name,
            path: '/subscribe_profiles', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ClinicsListRoute.name,
            path: '/subscribe_clinics', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ServicesListRoute.name,
            path: '/subscribe_services', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ResearchesListRoute.name,
            path: '/subscribe_researches', guards: [checkIsAuthUser]),
        _i32.RouteConfig(SpecialisationsListRoute.name,
            path: '/subscribe_specialisations', guards: [checkIsAuthUser]),
        _i32.RouteConfig(DoctorsListRoute.name,
            path: '/subscribe_doctors', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ResearchCabinetsListRoute.name,
            path: '/subscribe_research_cabinets', guards: [checkIsAuthUser]),
        _i32.RouteConfig(FavoriteDoctorsListRoute.name,
            path: '/subscribe_favorite_doctors', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ScheduleRoute.name,
            path: '/subscribe_schedule', guards: [checkIsAuthUser]),
        _i32.RouteConfig(ConfirmationSubscribeRoute.name,
            path: '/subscribe_confirm', guards: [checkIsAuthUser]),
        _i32.RouteConfig(MedcardProfilesListRoute.name,
            path: '/medcard', guards: [checkIsAuthUser]),
        _i32.RouteConfig(MedcardRoute.name,
            path: '/medcard_files_list', guards: [checkIsAuthUser]),
        _i32.RouteConfig(FilesRoute.name,
        ...
        _i32.RouteConfig(AgreementsRoute.name, path: '/settings_agreements'),
        _i32.RouteConfig(AllClinicsListRoute.name,
            path: '/clinic_info', guards: [checkIsAuthUser]),
        _i32.RouteConfig(DetailClinicRoute.name,
            path: '/clinic_info_details', guards: [checkIsAuthUser]),
        _i32.RouteConfig(PriceRoute.name,
            path: '/clinic_info_price', guards: [checkIsAuthUser]),
        _i32.RouteConfig(SalesRoute.name,
            path: '/clinic_info_sales', guards: [checkIsAuthUser]),
        _i32.RouteConfig(HealthRoute.name,
            path: '/health', guards: [checkIsAuthUser]),
        _i32.RouteConfig(DiaryRoute.name,
            path: '/diary', guards: [checkIsAuthUser]),
        _i32.RouteConfig(DiaryAddRoute.name,
            path: '/diary_add', guards: [checkIsAuthUser]),
        _i32.RouteConfig(FiltersRoute.name,
...
class StartPhoneNumberRoute
    extends _i32.PageRouteInfo<StartPhoneNumberRouteArgs> {
...
/// generated route for
/// [_i2.PasswordPage]
class PasswordRoute extends _i32.PageRouteInfo<PasswordRouteArgs> {
  PasswordRoute({_i33.Key? key, required String phoneNumber})
...
class CreatePinCodeRoute extends _i32.PageRouteInfo<void> {
...
class CheckPinCodeRoute extends _i32.PageRouteInfo<void> {
...
class RecoverPasswordSmsRoute
    extends _i32.PageRouteInfo<RecoverPasswordSmsRouteArgs> {
  RecoverPasswordSmsRoute({_i33.Key? key, required String phoneNumber})
...
class RecoverPasswordNewRoute
    extends _i32.PageRouteInfo<RecoverPasswordNewRouteArgs> {
  RecoverPasswordNewRoute({_i33.Key? key, required String smsToken})
...
class AppointmentsRoute extends _i32.PageRouteInfo<AppointmentsRouteArgs> {
  AppointmentsRoute({_i33.Key? key, bool? isRefresh = false})
...
class ProfilesListRoute extends _i32.PageRouteInfo<void> {
...
class ClinicsListRoute extends _i32.PageRouteInfo<ClinicsListRouteArgs> {
  ClinicsListRoute({_i33.Key? key, required String userId})
...
class ServicesListRoute extends _i32.PageRouteInfo<ServicesListRouteArgs> {
  ServicesListRoute(
      {_i33.Key? key,
...
class ResearchesListRoute extends _i32.PageRouteInfo<ResearchesListRouteArgs> {
  ResearchesListRoute(
      {_i33.Key? key,
      required String userId,
      required String buildingId,
...
class SpecialisationsListRoute
    extends _i32.PageRouteInfo<SpecialisationsListRouteArgs> {
...
class DoctorsListRoute extends _i32.PageRouteInfo<DoctorsListRouteArgs> {
  DoctorsListRoute(
      {_i33.Key? key,
      required String userId,
      required String buildingId,
...
class ResearchCabinetsListRoute
    extends _i32.PageRouteInfo<ResearchCabinetsListRouteArgs> {
...
class FavoriteDoctorsListRoute
    extends _i32.PageRouteInfo<FavoriteDoctorsListRouteArgs> {
...
/// generated route for
/// [_i17.SchedulePage]
class ScheduleRoute extends _i32.PageRouteInfo<ScheduleRouteArgs> {
  ScheduleRoute(
      {_i33.Key? key,
...
class ConfirmationSubscribeRoute
    extends _i32.PageRouteInfo<ConfirmationSubscribeRouteArgs> {
  ConfirmationSubscribeRoute({_i33.Key? key, required String userId})
...
class MedcardProfilesListRoute extends _i32.PageRouteInfo<void> {
...
/// generated route for
/// [_i20.MedcardPage]
class MedcardRoute extends _i32.PageRouteInfo<MedcardRouteArgs> {
  MedcardRoute(
      {_i33.Key? key, required String userId, required bool isChildrenPage})
...
/// generated route for
/// [_i21.FilesPage]
class FilesRoute extends _i32.PageRouteInfo<FilesRouteArgs> {
  FilesRoute({_i33.Key? key, required String userId})
...
/// generated route for
/// [_i23.AgreementsPage]
class AgreementsRoute extends _i32.PageRouteInfo<void> {
...
class AllClinicsListRoute extends _i32.PageRouteInfo<void> {
...
class DetailClinicRoute extends _i32.PageRouteInfo<DetailClinicRouteArgs> {
  DetailClinicRoute({_i33.Key? key, required _i35.ClinicModel selectedClinic})
...
class DetailClinicRouteArgs {
  ...
  final _i35.ClinicModel selectedClinic;
...
/// generated route for
/// [_i26.PricePage]
class PriceRoute extends _i32.PageRouteInfo<PriceRouteArgs> {
  PriceRoute({_i33.Key? key, required String clinicId})
...
class SalesRoute extends _i32.PageRouteInfo<SalesRouteArgs> {
  SalesRoute({_i33.Key? key, required String clinicId})
...
/// generated route for
/// [_i28.HealthPage]
class HealthRoute extends _i32.PageRouteInfo<void> {
...
/// generated route for
/// [_i29.DiaryPage]
class DiaryRoute extends _i32.PageRouteInfo<DiaryRouteArgs> {
  DiaryRoute(
      {_i33.Key? key,
      required String title,
      required _i36.DiaryCategoryModel categoryModel})
...
class DiaryRouteArgs {
  ...
  final _i36.DiaryCategoryModel categoryModel;
...
/// generated route for
/// [_i30.DiaryAddPage]
class DiaryAddRoute extends _i32.PageRouteInfo<DiaryAddRouteArgs> {
  DiaryAddRoute(
      {_i33.Key? key,
      required String title,
...
/// generated route for
/// [_i31.FiltersPage]
class FiltersRoute extends _i32.PageRouteInfo<void> {
