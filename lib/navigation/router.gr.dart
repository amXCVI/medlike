...
import 'package:medlike/modules/about_clinic/detail_clinic_with_bottom_sheets/clinic_detail_with_bottom_sheets_page.dart'
    as _i31;
import 'package:medlike/modules/about_clinic/price/price_page.dart' as _i32;
import 'package:medlike/modules/about_clinic/sales/sales_page.dart' as _i33;
import 'package:medlike/modules/appointments/appointments_page.dart' as _i12;
import 'package:medlike/modules/health/diary_add_page/diary_add_page.dart'
    as _i37;
import 'package:medlike/modules/health/diary_page/diary_page.dart' as _i36;
import 'package:medlike/modules/health/health_page/cards_page.dart' as _i35;
import 'package:medlike/modules/health/health_page/health_page.dart' as _i34;
...
import 'package:medlike/modules/login/unauth_support/unauth_support_page.dart'
    as _i8;
import 'package:medlike/modules/main_page/main_page.dart' as _i11;
import 'package:medlike/modules/medcard/files/files_page.dart' as _i26;
...
import 'package:medlike/modules/settings/agreements/agreements_page.dart'
    as _i28;
import 'package:medlike/modules/settings/settings_page.dart' as _i27;
import 'package:medlike/modules/settings/support/support_page.dart' as _i29;
...
import 'package:medlike/modules/subscribe/researches_list/researches_list_page.dart'
    as _i16;
import 'package:medlike/modules/subscribe/schedule/schedule_page.dart' as _i21;
...
class AppRouter extends _i39.RootStackRouter {
  ...
  final Map<String, _i39.PageFactory> pagesMap = {
    ...
    AppointmentsRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child:
              _i12.AppointmentsPage(key: args.key, isRefresh: args.isRefresh));
    },
    SubscribeProfilesListRoute.name: (routeData) {
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i13.SubscribeProfilesListPage());
    },
    ClinicsListRoute.name: (routeData) {
      final args = routeData.argsAs<ClinicsListRouteArgs>();
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i14.ClinicsListPage(
              key: args.key,
              userId: args.userId,
    ...
    SpecialisationsListRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i17.SpecialisationsListPage(
              key: args.key,
              userId: args.userId,
              buildingId: args.buildingId,
              clinicId: args.clinicId,
    ...
    ResearchCabinetsListRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i19.ResearchCabinetsListPage(
              key: args.key,
              userId: args.userId,
              buildingId: args.buildingId,
              clinicId: args.clinicId,
    ...
    FavoriteDoctorsListRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i20.FavoriteDoctorsListPage(
              key: args.key,
              userId: args.userId,
              buildingId: args.buildingId,
              clinicId: args.clinicId));
    ...
    ConfirmationSubscribeRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i22.ConfirmationSubscribePage(
              key: args.key,
              userId: args.userId,
    ...
    PaymentRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i23.PaymentPage(key: args.key, userId: args.userId));
    },
    MedcardProfilesListRoute.name: (routeData) {
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i24.MedcardProfilesListPage());
    },
    MedcardRoute.name: (routeData) {
      final args = routeData.argsAs<MedcardRouteArgs>();
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i25.MedcardPage(
              key: args.key,
              userId: args.userId,
              isChildrenPage: args.isChildrenPage));
    },
    FilesRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i26.FilesPage(key: args.key, userId: args.userId));
    },
    ...
    ClinicDetailWithBottomSheetsRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i31.ClinicDetailWithBottomSheetsPage(
    ...
    PriceRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i32.PricePage(key: args.key, clinicId: args.clinicId));
    },
    SalesRoute.name: (routeData) {
      final args = routeData.argsAs<SalesRouteArgs>();
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i33.SalesPage(key: args.key, clinicId: args.clinicId));
    },
    HealthRoute.name: (routeData) {
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i34.HealthPage());
    },
    CardsRoute.name: (routeData) {
      final args = routeData.argsAs<CardsRouteArgs>();
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i35.CardsPage(
    ...
    RequireUpdateAppRoute.name: (routeData) {
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i38.RequireUpdateAppPage());
    }
  };
  ...
  List<_i39.RouteConfig> get routes => [
        ...
        _i39.RouteConfig(EsiaLoginRoute.name, path: '/login-esia-login-page'),
        _i39.RouteConfig(EsiaRegisterRoute.name,
            path: '/login-esia-register-page'),
...
/// generated route for
/// [_i9.EsiaLoginPage]
class EsiaLoginRoute extends _i39.PageRouteInfo<void> {
  const EsiaLoginRoute()
      : super(EsiaLoginRoute.name, path: '/login-esia-login-page');

  static const String name = 'EsiaLoginRoute';
}

/// generated route for
/// [_i10.EsiaRegisterPage]
class EsiaRegisterRoute extends _i39.PageRouteInfo<EsiaRegisterRouteArgs> {
  EsiaRegisterRoute(
      {_i40.Key? key,
...
/// generated route for
/// [_i13.SubscribeProfilesListPage]
...
/// generated route for
/// [_i22.ConfirmationSubscribePage]
...
/// generated route for
/// [_i31.ClinicDetailWithBottomSheetsPage]
