...
class AppRouter extends _i39.RootStackRouter {
  ...
  final _i41.CheckIsOneClinicForPrice checkIsOneClinicForPrice;

  final _i41.CheckIsOneClinicForDetails checkIsOneClinicForDetails;

  final _i41.CheckIsOneClinicForMain checkIsOneClinicForMain;

  final _i41.CheckIsOneProfileForHealth checkIsOneProfileForHealth;

  final _i41.CheckIsOneProfileForMain checkIsOneProfileForMain;
  ...
  final Map<String, _i39.PageFactory> pagesMap = {
    ...
    DocumentRoute.name: (routeData) {
      ...
      return _i39.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i37.DocumentPage(key: args.key, document: args.document));
    },
  ...
  List<_i39.RouteConfig> get routes => [
        ...
        _i39.RouteConfig(DocumentsRoute.name,
            path: '/documents', guards: [checkIsAuthUser]),
        _i39.RouteConfig(DocumentRoute.name,
            path: '/document_detail', guards: [checkIsAuthUser]),
...
/// generated route for
/// [_i36.DocumentsPage]
class DocumentsRoute extends _i39.PageRouteInfo<void> {
...
/// generated route for
/// [_i37.DocumentPage]
class DocumentRoute extends _i39.PageRouteInfo<DocumentRouteArgs> {
  DocumentRoute({_i40.Key? key, required _i44.DocumentModel document})
      : super(DocumentRoute.name,
            path: '/document_detail',
            args: DocumentRouteArgs(key: key, document: document));

  static const String name = 'DocumentRoute';
}

class DocumentRouteArgs {
  const DocumentRouteArgs({this.key, required this.document});

  final _i40.Key? key;

  final _i44.DocumentModel document;
