...
import 'package:medlike/modules/login/create_pin_code_page/pin_code_page.dart'
    as _i3;
import 'package:medlike/modules/login/esia_auth/esia_login_page.dart' as _i9;
...
class AppRouter extends _i38.RootStackRouter {
  ...
  final Map<String, _i38.PageFactory> pagesMap = {
    ...
    EsiaLoginRoute.name: (routeData) {
      return _i38.AdaptivePage<dynamic>(
          routeData: routeData, child: const _i9.EsiaLoginPage());
    },
  ...
  List<_i38.RouteConfig> get routes => [
        ...
        _i38.RouteConfig(EsiaLoginRoute.name, path: '/esia-login-page'),
...
/// generated route for
/// [_i9.EsiaLoginPage]
class EsiaLoginRoute extends _i38.PageRouteInfo<void> {
  const EsiaLoginRoute() : super(EsiaLoginRoute.name, path: '/esia-login-page');
...
class AppointmentsRoute extends _i38.PageRouteInfo<AppointmentsRouteArgs> {
  AppointmentsRoute({_i39.Key? key, bool? isRefresh = false})
