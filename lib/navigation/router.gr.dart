...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    WebRecoverPasswordSmsRoute.name: (routeData) {
      final args = routeData.argsAs<WebRecoverPasswordSmsRouteArgs>();
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: WebRecoverPasswordSmsPage(
          key: args.key,
          phoneNumber: args.phoneNumber,
          timerEnd: args.timerEnd,
        ),
      );
    },
...
class ScheduleRouteArgs {
  ...
  @override
  String toString() {
    return 'ScheduleRouteArgs{key: $key, pageTitle: $pageTitle, pageSubtitle: $pageSubtitle, userId: $userId, buildingId: $buildingId, clinicId: $clinicId, doctorId: $doctorId, specialisationId: $specialisationId, researchIds: $researchIds, categoryTypeId: $categoryTypeId, cabinetId: $cabinetId, isAny: $isAny, isFavorite: $isFavorite}';
  }
}
...
/// generated route for
/// [WebRecoverPasswordSmsPage]
class WebRecoverPasswordSmsRoute
    extends PageRouteInfo<WebRecoverPasswordSmsRouteArgs> {
  WebRecoverPasswordSmsRoute({
    Key? key,
    required String phoneNumber,
    required DateTime? timerEnd,
    List<PageRouteInfo>? children,
  }) : super(
          WebRecoverPasswordSmsRoute.name,
          args: WebRecoverPasswordSmsRouteArgs(
            key: key,
            phoneNumber: phoneNumber,
            timerEnd: timerEnd,
          ),
  ...
  static const String name = 'WebRecoverPasswordSmsRoute';

  static const PageInfo<WebRecoverPasswordSmsRouteArgs> page =
      PageInfo<WebRecoverPasswordSmsRouteArgs>(name);
}

class WebRecoverPasswordSmsRouteArgs {
  const WebRecoverPasswordSmsRouteArgs({
    this.key,
    required this.phoneNumber,
  ...
  @override
  String toString() {
    return 'WebRecoverPasswordSmsRouteArgs{key: $key, phoneNumber: $phoneNumber, timerEnd: $timerEnd}';
  }
}
